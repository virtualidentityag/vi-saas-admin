...
export const PostCodeRanges = (props: {
    ...
    const addAction = () => {
        const postcodeFromAddValue = formInputData.getFieldsValue().postcodeFromAdd as string;
        const postcodeUntilAdd = formInputData.getFieldsValue().postcodeUntilAdd as string;
        postCodeRanges.push({
