    ...
    if (direction === DIRECTION_LEFT || direction === DIRECTION_RIGHT) {
      ...
      if (triggerY + top + triggerHeight > document.body.clientHeight) {
        pos.bottom =
          triggerHeight / 2 -
          18 +
          parseInt(triggerComputedStyle.marginBottom, 10);
        setTooltipPosition(TOOLTIP_POSITION_TOP);
      } else if (triggerY - top - triggerHeight < 0) {
        pos.top =
          triggerHeight / 2 - 18 + parseInt(triggerComputedStyle.marginTop, 10);
      ...
      if (triggerX + left + triggerWidth > document.body.clientWidth) {
        pos.right =
          triggerWidth / 2 -
          18 +
          parseInt(triggerComputedStyle.marginRight, 10);
        setTooltipPosition(TOOLTIP_POSITION_LEFT);
      } else if (triggerX - left - triggerWidth < 0) {
        pos.left =
          triggerWidth / 2 - 18 + parseInt(triggerComputedStyle.marginLeft, 10);
