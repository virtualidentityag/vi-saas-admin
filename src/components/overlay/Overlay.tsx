...
export const Overlay = (props: {
    ...
    const [activeOverlay, setActiveOverlay] = useState<OverlayItem>(
        props.item ? { ...props.item, ...props.handleOverlay } : props.items?.[activeStep],
    );
    ...
    return (
        ...
        >
            ...
            <div className="overlay__content">
                    ...
                    <div className="overlay__illustrationWrapper">
                        <span
                            className={clsx('overlay__illustration', {
                                'overlay__illustration--error': activeOverlay.illustrationBackground === 'error',
                                'overlay__illustration--info': activeOverlay.illustrationBackground === 'info',
                ...
                {activeOverlay.copy && <Text text={activeOverlay.copy} type="standard" />}
                {activeOverlay.nestedComponent && (
                    <div className="overlay__nestedComponent">{activeOverlay.nestedComponent}</div>
                )}
