...
const TenantsList = () => {
    ...
    const [editingTenant, setEditingTenant] = useState<TenantData | undefined>(undefined);
    ...
    const columns: any[] = [
        ...
        },
        {
            ...
            ellipsis: true,
            width: 150,
            sorter: (a: TenantData, b: TenantData) => moment(a.createDate).unix() - moment(b.createDate).unix(),
            render: (date: Date) => {
        ...
        },
        {
            ...
            width: 150,
            ellipsis: true,
            render: (record: { licensing: { allowedNumberOfUsers: number } }) => record.licensing.allowedNumberOfUsers,
            /* sorter: (a: TenantData, b: TenantData) =>
    ...
    return (
        <>
            ...
            />
            <ModalForm
                title={editingTenant ? t('organisation.modal.headline.edit') : t('organisation.modal.headline.add')}
